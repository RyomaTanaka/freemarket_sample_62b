...
lady = Categorei.create(name: "レディース")
...
# ベビー・キッズ
baby_kids = Categorei.create(name: "ベビー・キッズ")
...
# インテリア・住まい・小物
interior_residence_accessory = Categorei.create(name: "インテリア・住まい・小物")
...
# 本・音楽・ゲーム
book_music_game = Categorei.create(name: "本・音楽・ゲーム")
...
# おもちゃ・ホビー・グッズ
toy_hobby_goods = Categorei.create(name: "おもちゃ・ホビー・グッズ")
...
# コスメ・香水・美容
cosme_perfume_beauty = Categorei.create(name: "コスメ・香水・美容")
...
# 家電・スマホ・カメラ
appliance_smartphone_camera = Categorei.create(name: "家電・スマホ・カメラ")
...
# スポーツ・レジャー
sport_leisure = Categorei.create(name: "スポーツ・レジャー")
...
# ハンドメイド
handmade = Categorei.create(name: "ハンドメイド")
...
# チケット
ticket = Categorei.create(name: "チケット")
...
# 自動車・オートバイ
car_motorcycle = Categorei.create(name: "自動車・オートバイ")
